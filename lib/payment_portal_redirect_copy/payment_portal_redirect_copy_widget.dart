                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              StreamBuilder<List<PriceRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<PriceRecord> textPriceRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the document does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final textPriceRecord =
                                      textPriceRecordList.isNotEmpty
                                          ? textPriceRecordList.first
                                          : null;
                                  return Text(
                                    'USD ${textPriceRecord!.price.toString()}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<PriceRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<PriceRecord> containerPriceRecordList =
                            snapshot.data!;
                        // Return an empty Container when the document does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final containerPriceRecord =
                            containerPriceRecordList.isNotEmpty
                                ? containerPriceRecordList.first
                                : null;
                        return Container(
