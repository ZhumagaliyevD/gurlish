...
import '../shop_sale/shop_sale_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:google_fonts/google_fonts.dart';

class ShopSearchWidget extends StatefulWidget {
  const ShopSearchWidget({Key? key}) : super(key: key);

  @override
  _ShopSearchWidgetState createState() => _ShopSearchWidgetState();
}
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ShopSaleWidget(),
                              ),
                            );
                          },
                          child: Text(
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => EditorsPickWidget(),
                              ),
                            );
                          },
                          child: Text(
